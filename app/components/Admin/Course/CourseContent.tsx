                  ...
                  <>
                    <div className="flex w-full items-center">
                      <input
                        ...
                        // }}
                        onChange={(e) => {
                          const updatedData = courseContentData.map((dataa : any, i:number) => 
                            i === index ? { ...dataa, videoSection: e.target.value } : dataa
                          );
                          setCourseContentData(updatedData);
                        }}
                  ...
                  <>
                    <div className="my-3">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const updatedData = courseContentData.map((dataa : any, i:number) => 
                            i === index ? { ...dataa, title: e.target.value } : dataa
                          );
                          setCourseContentData(updatedData);
                        }}
                          ...
                          onChange={(e) => {
                            const updatedData = courseContentData.map((dataa:any, i:number) => {
                              if (i === index) {
                                return {
                                  ...dataa,
                                  links: dataa.links.map((linc:any, j:number) => {
                                    if (j === linkIndex) {
                                      return { ...linc, title: e.target.value };
                                    }
                                    return linc;
                                  }),
                                };
